...
The second part of this practical will introduces you to **Attribute Joins** and [choropleth maps](https://en.wikipedia.org/wiki/Choropleth_map). You will be using different types of *joins* throughout this practical, this module in general, and probably the rest of your career, so it is incredibly important that you understand how these work.
...
- Export your joined dataset (London only) as a `GeoPackage` and save this into your `data` folder as `LSOA2011_London.gpkg`. <u>We will use this file in later weeks.</u>
