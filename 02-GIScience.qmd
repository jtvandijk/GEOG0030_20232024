...
::: { .callout-warning}
Whereas the above map is fine for today, it is technically incorrect because we are showing <u>absolute</u> numbers on a choropleth. This is something we should **never** do, unless the spatial units are identical in size (e.g. a hexagonal tessellation of an area), because larger areas will draw attention and affect the visualisation.
:::
