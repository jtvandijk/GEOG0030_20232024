...
::: {.callout-warning}
There may be some small differences between the numbers in your output and the numbers shown here. If so, this is due to retrospective updates made to the police data (e.g. updates to attribute information, corrections) that were made after the data was downloaded for the generation of this year's Geocomputation workbook.
:::
