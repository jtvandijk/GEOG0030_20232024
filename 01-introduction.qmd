...
::: { .callout-note}
We recommend installing the **Long Term Release** (*QGIS 3.22 LTR*) as this version should be the most stable version. For Windows users: be aware that the QGIS installation may be a little slow.
:::
...
#| echo: False
#| cache: True
#| fig-cap: "The RStudio Server interface."
...
::: { .callout-warning}
Even if you have used R or RStudio Server before and already installed some of the packages in the above list, do re-install all packages by running to code above to make sure you have the latest versions. Legacy installations that have not been updated may lay lead to problems when going through the tutorials.
:::
