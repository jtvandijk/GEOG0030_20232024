...
Open a new script within your GEOG0030 project and save this script as `wk6-population-analysis.r`. At the top of your script, add the following metadata:
...
Our map shows quite clear hot spots of self-identified Asian-Bangladeshis across London. 
