...
pollution <- importKCL(site=c(measurement_sites$code), year=2022:2022, pollutant='no2',meta=TRUE)
```
...
tm_shape(measurement_sites) +
  tm_bubbles(
    ...
    style = "pretty",
    border.col = "white",
    title.size="Average NO2 ug/m3 reading in 2020"
    ) +
  # add legend
  tm_layout(
